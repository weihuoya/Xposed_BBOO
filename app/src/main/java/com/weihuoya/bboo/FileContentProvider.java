...
public class FileContentProvider extends ContentProvider {
    ...
    public static final String BASE_URI = "content://com.weihuoya.bboo.htmlfileprovider";
    ...
    public ParcelFileDescriptor openFile(Uri uri, String mode) throws FileNotFoundException {
        ...
        return ParcelFileDescriptor.open(new File(filename), ParcelFileDescriptor.MODE_READ_ONLY);
    }
